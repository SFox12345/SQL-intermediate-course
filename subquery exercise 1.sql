...
WHERE
	pp.Street = 'Ranmere Street'
    AND pp.PropertyType = ptl.PropertyTypeCode)
...
Select 
    ...
    FROM
    PropertyTypeLookup
    Left Join PricePaidSW12 pp ON ptl.PropertyTypeCode = pp.PropertyType
    AND pp.Street = 'Ranmere Street'
WHERE pp.PropertyType IS NULL
